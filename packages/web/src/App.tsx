...
import { CallSearchWidget } from "./components/call/CallSearchWidget";
...
export default function App() {
  ...
  // Mounted at the app root, not inside the /consult page, so a patient who navigates away
  // mid-search (via the minimize widget below) keeps hearing about call:accepted/call:ended.
  useCallListener();
